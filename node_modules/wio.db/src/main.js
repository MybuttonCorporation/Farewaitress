...
const { set, unset, get, cloneDeep, isBoolean } = require("lodash");
...
const parseValue = (value) => {
    if ((!value || value === "") && !isNumber(value) && !isBoolean(value)) throw new DatabaseError(`The value was specified incorrectly.`);
    return value;
};
